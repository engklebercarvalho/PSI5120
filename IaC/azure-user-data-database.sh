...
mysql --database PSI5120 -e "INSERT INTO Alunos (AlunoID, Ambiente, Nome, Sobrenome) VALUES (10, 'Azure', 'Kleber', 'Carvalho');"
mysql --database PSI5120 -e "INSERT INTO Alunos (AlunoID, Ambiente, Nome, Sobrenome) VALUES (10, 'Azure', 'Bruno', 'Luz');"
